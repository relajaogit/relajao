    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About section */}
          <div>
            <h3 className="text-xl font-bold mb-4">Relajao</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/properties" className="text-gray-300 hover:text-white">{t.nav.properties}</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">{t.contact.info.address.line2}, {t.contact.info.address.line3}</p>
            <p className="text-gray-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href={`tel:${t.contact.info.phone.number}`} className="hover:text-rose-300">
            ...
            <p className="text-gray-300 flex items-center mt-2">
              ...
              <a href={`mailto:${t.contact.info.email.address}`} className="hover:text-rose-300">
