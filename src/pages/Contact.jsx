...
function Contact() {
  ...
  const whatsappLabel = language === 'es' ? 'Escribir por WhatsApp' : 'Message on WhatsApp';
  const whatsappMsg = language === 'es'
    ? '¡Hola! Me gustaría obtener más información, ¿me puedes ayudar?'
    : 'Hello! I would like more information, can you help me?';
        ...
        <div className="bg-gray-50 rounded-lg shadow-lg p-8">
          ...
          <div className="p-4 border border-green-200 bg-green-50 rounded-lg mb-6">
            <p className="text-green-800 mb-3">
              {language === 'es'
                ? '¿Prefieres WhatsApp? Escríbenos y te respondemos pronto.'
                : 'Prefer WhatsApp? Message us and we’ll get back to you soon.'}
            </p>
            <WhatsAppButton
              fullWidth
              label={whatsappLabel}
          ...
          <div className="space-y-8">
            ...
            <div className="flex">
              <div className="flex-shrink-0">
                <svg className="h-6 w-6 text-rose-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900">Calle 1#7-14 Oficina 301 Popayán Colombia{t.contact.info.address.title}</h3>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900">+57 321 6365241{t.contact.info.phone.title}</h3>
                <p className="mt-2 text-gray-600">
                  <a href="tel:+573216365241" className="hover:text-rose-600">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900">aptosrelajao@gmail.com{t.contact.info.email.title}</h3>
                <p className="mt-2 text-gray-600">
                  <a href="mailto:aptosrelajao@gmail.com" className="hover:text-rose-600">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-medium text-gray-900">9am - 4pm{t.contact.info.hours.title}</h3>
